...
tellraw @s[tag=playergravity] {"text":"Currently held by a player!","color":"dark_red"}
execute as @s[tag=playergravity] at @s run playsound minecraft:block.note_block.hat player @s ~ ~ ~ 1 0.5

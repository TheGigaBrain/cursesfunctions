execute if data entity @s {SelectedItem:{tag:{WandSpell:"death"}}} run function curses:8-magic/usewand/death
execute if data entity @s {SelectedItem:{tag:{WandSpell:"cleansing"}}} run function curses:8-magic/usewand/cleansing
execute if data entity @s {SelectedItem:{tag:{WandSpell:"fireball"}}} run function curses:8-magic/usewand/fireball
